...
/*
  * iterate over array 
  * for each item get first and last digit
  * if item has 1 digit return this digit twice
  * if item has 2 digit concatenate it
...
function extractNumbers(str) {
  const regex = /([0-9])|(one|two|three|four|five|six|seven|eight|nine)/gi
...
const calculateCalibrationValue = (values) => {
  let sum = 0;
  values.forEach(item => {
